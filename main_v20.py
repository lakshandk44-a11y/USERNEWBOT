...
def call_gemini(prompt, retries=3, label="gemini"):
    ...
    # gemini-2.5-flash-lite: free tier daily quota is 1,000-1,500 requests/day
    # vs gemini-3.5-flash's 20/day limit — the actual cause of the 429 errors.
    # RPM (15) is similar between the two, so GEMINI_RPM_LIMIT stays unchanged.
        ...
        requests.post(
            ...
            json={
                ...
                "text": (
                    ...
                    f"_{preview}_\n\n"
                    f"Tap the button below → opens the post → share to your groups 👇"
                ),
                "parse_mode": "Markdown",
                "reply_markup": {
                    "inline_keyboard": [[
                        {"text": "📤 Open Post & Share", "url": post_url},
                    ]]
                },
            },
            timeout=REQUEST_TIMEOUT,
